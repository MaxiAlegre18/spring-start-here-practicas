package com.aprendizaje.spring.cap6.ex1_simpleAspect.config;
...
import com.aprendizaje.spring.cap6.ex1_simpleAspect.aspects.LoggingAspect;

@Configuration
@ComponentScan(basePackages = "com.aprendizaje.spring.cap6.ex1_simpleAspect")
/*
